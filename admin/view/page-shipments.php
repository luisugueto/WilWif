				...
				<thead style="border: 5px;">
							...
							?>
								<tbody style="border: 5px solid; border-color: white;">
									<tr>
											...
											<td style="border-bottom: 5px solid; border-top: 0px solid; border-left: 0px; border-right: 5px solid; border-color: white;"><p style="color: white"><?php echo $assoc_busqueda['id_user_recive']; ?></td>
					...
					<tbody style="border: 5px solid; border-color: white;">
									<tr>
											...
											<td style="border-bottom: 5px solid; border-top: 0px solid; border-left: 0px; border-right: 5px solid; border-color: white;"><p style="color: white"><?php echo $sql_assoc['id_user_recive']; ?></td>

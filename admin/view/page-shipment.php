			...
			<div class="images_container">
						...
						<ul id="list_images" class="list_images">
							...
							<?php if($shipment->shipment_item->HasPhoto())
								...
								?>
									<li>
										<div style="background: transparent url('<?php echo $GLOBALS['configuration']->getOption('domain').$shipment->shipment_item->item_photos_url[$i]?>') no-repeat scroll 0% 0% / 100% 100%;"></div>
									</li>
								<?php
								}
								}else{
